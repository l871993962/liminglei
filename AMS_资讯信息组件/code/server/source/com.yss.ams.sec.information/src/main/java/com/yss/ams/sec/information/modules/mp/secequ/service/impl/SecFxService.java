 ...
 * 20121009
 */
public class SecFxService extends ServiceBus<SecFxService> implements
		ISecFxService {

	private SecEquDao serviceDao = null;

	public SecFxService() throws Exception {
	...
	public QueryRes queryByCondition(HashMap<String, Object> paraMap,
		...
		try {
			...
			secEquService.setMenuId("sv_securityPublish");
			...
			List<HeadKey> list = context.getListHeadMap("sv_securityPublish").getHeadKeyList();
