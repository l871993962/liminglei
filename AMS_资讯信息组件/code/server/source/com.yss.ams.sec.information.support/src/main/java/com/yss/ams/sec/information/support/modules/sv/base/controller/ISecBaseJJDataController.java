...
impl = "com.yss.ams.sec.information.modules.sv.base.service.impl.SecBaseJJDataService",
interfaceClass = com.yss.ams.sec.information.support.modules.sv.base.service.ISecBaseJJDataService.class,
productLine = ProductLine.SECINFO, serviceMapId = "ISecBaseJJDataService", menuId = "sv_sec")
public interface ISecBaseJJDataController extends IBaseController<ISecBaseJJDataService> {
    ...
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    public List<SecBase> getSecCache(HashMap<String,String> paraMap)  throws Exception;
