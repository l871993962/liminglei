...
{
    ///<summary>
    /// 功能简介：现货品种信息浏览界面，负责现货品种信息的显示和查询功能的实现 
    /// 创建版本：V4.5.0.1
    /// 创建人： zgy
    /// 创建日期： 2013.03.25
    /// </summary>
    public partial class Frm_SEC_BASE_XH_L : FrmBaseList
    {
        /// <summary>
        /// dataService
        /// </summary>
        ...
        public override string yssInitQuery()
        {
            ...
            //// 1 查询条件
            string cond = ""; // "and b.C_DA_CODE like 'XH%'";
        ...
        public string yssGetListCond()
        {
            ...
            quyStrUtil.addQuyCon("C_DA_CODE", "C_DA_CODE", "XH", ClsConstant.SQL_RA_HYPHEN_LIKE, ClsConstant._LIKE_MARCH_LEFT);
            //// 查询条件按照：证券内码、ISIN代码、现货代码
