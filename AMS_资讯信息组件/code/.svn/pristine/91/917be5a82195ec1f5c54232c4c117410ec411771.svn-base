 ...
 *
 */
public class SecBaseCjDao extends GeneralDao {

	public SecBaseCjDao(DbPool pool, SQLBuilder sqlBuilder) {
	...
	public List<BasePojo> queryForSjsszq() {
		...
		SecBaseCjSqlBuilder sqlbuilder = null;
		BasePojo pojo = null;
		try {
			sqlbuilder = new SecBaseCjSqlBuilder();
