...
impl = "com.yss.ams.sec.information.modules.sv.base.service.impl.SecBaseYqService",
interfaceClass = com.yss.ams.sec.information.support.modules.sv.base.service.ISecBaseYqService.class,
productLine = ProductLine.SECINFO, serviceMapId = "ISecBaseYqService", menuId = "sv_forward")
public interface ISecBaseYqController extends IBaseServiceBusController<SecBase,ISecBaseYqService> {
