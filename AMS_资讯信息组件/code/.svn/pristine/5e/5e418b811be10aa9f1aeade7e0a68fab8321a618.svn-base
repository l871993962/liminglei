...
impl = "com.yss.ams.sec.information.modules.sv.base.dao.SecBaseGPDataService",
interfaceClass = com.yss.ams.sec.information.support.modules.sv.base.service.ISecBaseGPDataService.class,
productLine = ProductLine.SECINFO, serviceMapId = "ISecBaseGPDataService", menuId = "sv_sec")
public interface ISecBaseGPDataController extends IBaseController<ISecBaseGPDataService> {
