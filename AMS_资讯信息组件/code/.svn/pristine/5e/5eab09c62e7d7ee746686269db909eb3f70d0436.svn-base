...
impl = "com.yss.ams.sec.information.modules.sv.base.service.impl.SecBaseQZDataService",
interfaceClass = com.yss.ams.sec.information.support.modules.sv.base.service.ISecBaseQZDataService.class,
productLine = ProductLine.SECINFO, serviceMapId = "ISecBaseQZDataService", menuId = "sv_sec")
public interface ISecBaseQZDataController extends IBaseController<ISecBaseQZDataService> {
