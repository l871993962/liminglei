...
namespace YssSecInformation.Support.Sv.Service
{
    ...
    [ServiceAttribute(ServiceId = YssInformation.Support.common.ServiceIdConstant.OSGI_BASEBUSINESS, ServiceController = "com.yss.ams.sec.information.support.modules.sv.base.controller.ISecBaseCjController", ServiceUrl = "")]
    public interface ISecBaseCjService : IServiceBus
    {
        /// <summary>
        /// 条件查询
        /// </summary>
