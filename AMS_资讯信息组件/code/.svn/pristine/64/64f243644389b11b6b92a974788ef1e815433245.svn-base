...
impl = "com.yss.ams.sec.information.modules.sv.base.service.impl.SecBaseZQDataService",
interfaceClass = com.yss.ams.sec.information.support.modules.sv.base.service.ISecBaseZQDataService.class,
productLine = ProductLine.SECINFO, serviceMapId = "ISecBaseZQDataService", menuId = "sv_sec")
public interface ISecBaseZQDataController extends IBaseController<ISecBaseZQDataService> {
