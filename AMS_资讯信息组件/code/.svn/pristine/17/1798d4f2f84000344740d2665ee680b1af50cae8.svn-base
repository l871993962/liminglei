 ...
 */
public class SecBaseLlSqlBuilder implements SQLBuilder {

	/**
	 * 返回 根据前台查询条件获取利率品种信息数据总数量 的SQL
	 * @param paraNameList
	 * @return retSql
	 * @throws Exception
	 */
	public String getQueryConditionCountSql(List<String> paraNameList) throws Exception
	{
		...
		try
		{
			...
			buf.append(" where a.c_sec_var_code like 'LL%' ");
