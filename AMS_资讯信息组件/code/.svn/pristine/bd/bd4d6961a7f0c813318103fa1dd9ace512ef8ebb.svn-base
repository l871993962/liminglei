...
import com.yss.ams.sec.information.support.modules.sv.base.controller.ISecBaseJJDataController;
...
*/
public class SecBaseJJDataControllerImpl extends AbstractBaseController<ISecBaseJJDataService> implements ISecBaseJJDataController{
    ...
    public List<SecBase> getSecCache(HashMap<String,String> paraMap) throws Exception{
        return castToListT(getService().getSecCache(paraMap),SecBase.class);
    }
