 ...
 */
public class SecBaseYqSqlBuilder implements SQLBuilder
{

	/**
	 * 返回 根据前台查询条件获取 远期品种信息 数据总数量 的SQL
	 * @param paraNameList
	 * @return retSql
	 * @throws Exception
	 */
	public String getQueryConditionCountSql(List<String> paraNameList) throws Exception
	{
		...
		try
		{
			...
			buf.append(" where b.c_sec_var_code like 'YQ%' ");
	...
	/**
	 * 返回 根据前台查询条件获取 远期品种信息 所有数据 的SQL
	 * @param paraNameList
	 * @return retSql
	 * @throws Exception
	 */
