...
impl = "com.yss.ams.sec.information.modules.sv.base.service.impl.SecBaseWhService",
interfaceClass = com.yss.ams.sec.information.support.modules.sv.base.service.ISecBaseWhService.class,
productLine = ProductLine.SECINFO, serviceMapId = "ISecBaseWhService", menuId = "sv_forextradecat")
public interface ISecBaseWhController extends IBaseServiceBusController<SecBase,ISecBaseWhService> {
