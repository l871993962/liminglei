...
impl = "com.yss.ams.sec.information.modules.sv.base.service.impl.SecBaseService",
interfaceClass = com.yss.ams.sec.information.support.modules.sv.base.service.ISecBaseService.class,
productLine = ProductLine.SECINFO, serviceMapId = "ISecBaseService", menuId = "sv_sec")
public interface ISecBaseController extends IBaseServiceBusController<SecBase,ISecBaseService> {
