...
impl = "com.yss.ams.sec.information.modules.sv.indexinfo.service.impl.IndexInfoDataService",
interfaceClass = com.yss.ams.sec.information.support.modules.sv.indexinfo.service.IIndexInfoDataService.class,
productLine = ProductLine.SECINFO, serviceMapId = "IIndexInfoDataService", menuId = "sv_indexinfo")
public interface IIndexInfoDataController extends IBaseController<IIndexInfoDataService> {
