...
impl = "com.yss.ams.sec.information.modules.plateset.plate.service.impl.PlateDataService",
interfaceClass = com.yss.ams.sec.information.support.modules.plateset.plate.service.IPlateDataService.class,
productLine = ProductLine.SECINFO, serviceMapId = "IPlateDataService", menuId = "sv_sectorChild_A")
public interface IPlateDataController extends IBaseController<IPlateDataService> {
