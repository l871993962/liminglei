create or replace procedure PRC_DEP_CHK_CUR_PAIR_FWMKTVAL
...
begin
  ...
  v_checkCnt := 0;
   LOOP
      ...
      IF(v_field = 'C_CURY_PAIR_CODE') THEN
        v_quyCon := v_quyCon || 'C_SEC_CODE=''' || v_value || ''' AND';
      ELSE
...
end PRC_DEP_CHK_CUR_PAIR_FWMKTVAL;
