...
impl = "com.yss.ifa.szt.tool.para.service.impl.ErParaDataService",
interfaceClass = com.yss.ifa.szt.tool.para.service.IErParaDataService.class,
productLine = ProductLine.BASEINFO, serviceMapId = "IErParaDataService", menuId = "erPara")
public interface IErParaDataController extends IBaseController<IErParaDataService> {
