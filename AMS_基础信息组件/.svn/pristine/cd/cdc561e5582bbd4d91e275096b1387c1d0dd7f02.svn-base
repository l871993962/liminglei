...
impl = "com.yss.ams.base.information.modules.bi.salesnet.service.impl.SalesNetDataService",
interfaceClass = com.yss.ams.base.information.support.bi.salesnet.service.INetDataService.class,
productLine = ProductLine.BASEINFO, serviceMapId = "INetDataService", menuId = "base_taselnet")
public interface INetDataController extends IBaseController<INetDataService> {
