...
impl = "com.yss.ams.base.information.modules.bi.ieLink.service.impl.IeLinkDataService",
interfaceClass = com.yss.ams.base.information.support.bi.ieLink.service.IIeLinkDataService.class,
productLine = ProductLine.BASEINFO, serviceMapId = "IIeLinkDataService", menuId = "base_ieLink")
public interface IIeLinkDataController extends IBaseController<IIeLinkDataService> {
