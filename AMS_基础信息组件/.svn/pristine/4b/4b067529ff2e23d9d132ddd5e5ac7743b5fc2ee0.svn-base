...
impl = "com.yss.ams.base.information.modules.bi.ie.service.impl.IeDataService",
interfaceClass = com.yss.ams.base.information.support.bi.ie.service.IIeDataService.class,
productLine = ProductLine.BASEINFO, serviceMapId = "IIeDataService", menuId = "base_ie")
public interface IIeDataController extends IBaseController<IIeDataService> {
