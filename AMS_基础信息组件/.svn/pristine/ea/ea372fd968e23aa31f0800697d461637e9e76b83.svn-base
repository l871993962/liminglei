...
impl = "com.yss.ams.base.information.modules.bi.region.service.impl.AreaDataService",
interfaceClass = com.yss.ams.base.information.support.bi.region.service.IAreaDataService.class,
productLine = ProductLine.BASEINFO, serviceMapId = "IAreaDataService", menuId = "base_area")
public interface IAreaDataController extends IBaseController<IAreaDataService> {
