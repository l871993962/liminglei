...
/**
 * 财务项目字典表T_S_FIN_ITEM dao
 *
 */
public class FinItemDao extends GeneralDao {
	
	public FinItemDao(DbPool pool, SQLBuilder sqlBuilder) {
		super(pool, sqlBuilder);
	}

	/**
	 * 根据条件获取财务项目字典表T_S_FIN_ITEM符合条件的数据，并进行分页处理
	 */
	@Override
