...
public class AccEleDao extends GeneralDao {
	
	public AccEleDao(DbPool pool, SQLBuilder sqlBuilder) {
		super(pool, sqlBuilder);
	}

	@Override
	public List<BasePojo> queryByConditionPage(HashMap<String, Object> paraMap,
			PageInation page, Class<?> clazz) throws DataAccessException {
...
//			ex.printStackTrace();
	...
	public List<BasePojo> queryByCondition(HashMap<String, Object> paraMap,
			Class<?> clazz) throws DataAccessException {
		List<BasePojo> pojoList = new ArrayList<BasePojo>();
		List<String> paraNameList;
		PropertyDescriptor[] propertys = null;
		Object resValue = null;
	...
	/* START 数据服务方法 */
	public List<AccEle> getAllDataList() throws DataAccessException {
		List<AccEle> pojoList = new ArrayList<AccEle>();
		...
		AccEleSqlBuilder dsServiceBuilder = null;
		AccEle t = null;
		try {
			dsServiceBuilder = new AccEleSqlBuilder();
			...
			while (rs.next()) {
				t = rsTools.ResultToBeanGeneric(rs, AccEle.class);
				pojoList.add(t);
			}
	...
	public AccEle getDataByCode(String code) throws DataAccessException {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
	...
	public HashMap<String, String> getKeyConvertMap()
		...
		try {
			...
			while (rs.next()) {
				t = rsTools.ResultToBeanGeneric(rs, AccEle.class);
				keyValueMap.put(t.getC_DAE_CODE(), t.getC_DAE_NAME());
			}
