CREATE OR REPLACE PROCEDURE PRC_CHK_IDEN_NULL_DATA
IS
   v_sql         VARCHAR2 (4000);
   ...
   IS
        SELECT      'SELECT '''
         ...
         WHERE   NOT EXISTS
                 ...
                 AND t1.COLUMN_NAME = 'C_IDEN'
      ORDER BY   t1.Table_Name, t1.Column_ID;
BEGIN

   c_Exe_Type := 'CHK_IDEN_NULL';
   c_Exe_Prc  := 'PRC_CHK_IDEN_NULL_DATA';

   DELETE FROM T_CHK_EXCPTION_DATA WHERE C_EXE_TYPE =  'CHK_IDEN_NULL';
