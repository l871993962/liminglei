CREATE OR REPLACE PROCEDURE PRO_setDAE_CVT(daeName   in varchar2,
                                           daeValue  in out nocopy varchar2,
                                           dictName  in varchar2,
...
begin
  /*处理字典*/
  if (dictName is not null and b_km_plan = false) then
    pro_DAE_DICT_CVT(dictName, v_Value, dae_Row);
  end if;
