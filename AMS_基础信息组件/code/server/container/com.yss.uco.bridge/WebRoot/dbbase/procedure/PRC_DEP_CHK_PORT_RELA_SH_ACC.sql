create or replace procedure PRC_DEP_CHK_PORT_RELA_SH_ACC
...
begin
  ...
  v_checkCnt := 0;
   ...
   IF (LENGTH(v_quyCon) > 0) THEN
      ...
      v_rela_type_con := v_rela_type_con || ' AND C_RELA_TYPE=''RELA_SH_ACC'' ';
...
end PRC_DEP_CHK_PORT_RELA_SH_ACC;
