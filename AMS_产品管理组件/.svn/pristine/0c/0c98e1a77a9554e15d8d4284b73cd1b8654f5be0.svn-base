...
impl = "com.yss.ams.product.information.modules.cp.pubacc.service.impl.PubAccDataService",
interfaceClass = com.yss.ams.product.information.support.modules.cp.pubacc.service.IPubAccDataService.class,
productLine = ProductLine.PRODUCTINFO, serviceMapId = "IPubAccDataService", menuId = "pd_pubAccInfo")
public interface IPubAccDataController extends IBaseController<IPubAccDataService> {
