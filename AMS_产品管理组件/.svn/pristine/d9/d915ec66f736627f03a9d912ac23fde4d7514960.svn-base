...
impl = "com.yss.ams.product.information.modules.ab.port.service.impl.PortBDataService",
interfaceClass = com.yss.ams.product.information.support.modules.ab.port.service.IPortBDataService.class,
productLine = ProductLine.PRODUCTINFO, serviceMapId = "IPortBDataService", menuId = "pd_portfolio")
public interface IPortBDataController extends IBaseController<IPortBDataService> {
