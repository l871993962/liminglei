...
import com.yss.ams.product.information.support.modules.ab.port.controller.IPortBDataController;
...
*/
public class PortBDataControllerImpl extends AbstractBaseController<IPortBDataService> implements IPortBDataController{
