...
namespace YssProductInfo.Ab.PortGroup.Form
{
    ...
    public partial class Frm_PORT_GROUP_L : FrmBaseList
    {
        ...
        protected override Dictionary<string, string> OnGetParaAssemble(Dictionary<string, string> paraDict)
        {
            ...
            ////派工单 #2193 估值_V1.300.7.0_UI自动化测试_自动化测试(268)【产品群组管理】
        ...
        {
            if (null == this.groupRelaService)
            {
                this.groupRelaService = ServiceFactory.createService<IPortGroupRelaService>();
            }
        }
        ...
        protected override void btnNew_Click(object sender, EventArgs e)
        {
            ...
            {
                this.frmSet = new Frm_PORT_GROUP_S();
                this.frmSet.AllowRebuilderTable = true;
                this.frmSet.FrmList = this;
            }

            if (this.frmSet.ShowDialog(this) == DialogResult.OK)
            {
                savePort(this.frmSet.CheckedRows);
