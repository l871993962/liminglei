...
@RestfulSupported
public interface IPortRelaTradeSeatService extends IServiceBus {
	/**
	 * 组合关联交易席位
	 * 
	 * @param paraMap
	...
	public QueryRes queryPortRelaTradeSeatPage(@LinkControllerMethodArgu("paraMap")HashMap<String, Object> paraMap,
