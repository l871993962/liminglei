...
impl = "com.yss.ams.product.information.modules.ab.port.service.impl.PortDocDynamicCheckServiceOne",
interfaceClass = com.yss.ams.product.information.support.modules.ab.port.service.IPortDocDynamicCheckServiceOne.class,
productLine = ProductLine.PRODUCTINFO, serviceMapId = "IPortDocDynamicCheckServiceOne", menuId = "portfolio")
public interface IPortDocDynamicCheckServiceOneController extends IBaseController<IPortDocDynamicCheckServiceOne> {
	 ...
	 */
	@POST
    @Path("/getAllDataByFunCodeAndDataTime")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED + ";charset=UTF-8" })
	 ...
	 */
	@POST
    @Path("/getAllDataByFunCodeAndDataIds")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED + ";charset=UTF-8" })
