...
impl = "com.yss.fast.systemmanager.port.PortDeductionService",
interfaceClass = com.yss.platform.support.dataservice.service.IPortDeductionService.class,
productLine = ProductLine.PRODUCTINFO, serviceMapId = "IPortDeductionService", menuId = "portfolio")
public interface IPortDeductionController extends IBaseController<IPortDeductionService> {
