...
impl = "com.yss.ams.product.information.modules.ab.port.service.impl.PortDataService",
interfaceClass = com.yss.ams.product.information.support.modules.ab.port.service.IPortDataService.class,
productLine = ProductLine.PRODUCTINFO, serviceMapId = "IPortDataService", menuId = "pd_portfolio")
public interface IPortDataController extends IBaseController<IPortDataService> {
    ...
    @POST
    @Path("/getPortDataMapWithNullTrCode")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    ...
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED + ";charset=UTF-8" })
    public List<Port> doPortFilter1(@FormParam("isDataRight") String isDataRight,@FormParam("datClass") String datClass);

    @POST
    @Path("/doPortFilterRes1")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED + ";charset=UTF-8" })
    public RestfulQueryResult<Port> doPortFilterRes1(@FormParam("isDataRight") String isDataRight,@FormParam("datClass") String datClass);

    @POST
    @Path("/doPortFilter2")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED + ";charset=UTF-8" })
    public List<Port> doPortFilter2(@FormParam("isDataRight") String isDataRight,@FormParam("datClass") String datClass,@FormParam("dvPortCode") String dvPortCode);

    @POST
    @Path("/doPortFilterRes2")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED + ";charset=UTF-8" })
    public RestfulQueryResult<Port> doPortFilterRes2(@FormParam("isDataRight") String isDataRight,@FormParam("datClass") String datClass,@FormParam("dvPortCode") String dvPortCode);

    @POST
    @Path("/doPortFilter3")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED + ";charset=UTF-8" })
    public List<Port> doPortFilter3(@FormParam("isDataRight") String isDataRight,@FormParam("datClass") String datClass,@FormParam("dvPortCode") String dvPortCode,@FormParam("trCode") String trCode);
    ...
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED + ";charset=UTF-8" })
    public RestfulQueryResult<Port> doPortFilterRes3(@FormParam("isDataRight") String isDataRight,@FormParam("datClass") String datClass,@FormParam("dvPortCode") String dvPortCode,@FormParam("trCode") String trCode);
    ...
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED + ";charset=UTF-8" })
    public Map<String,String> getBindPortAndPost(@FormParam("userCode") String userCode,@FormParam("postCodes") String postCodes);
    ...
    @POST
    @Path("/getDataPropertiesListByCode")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    ...
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED + ";charset=UTF-8" })
    public List<Port> getPortTreeList(@FormParam("userCode") String userCode,@FormParam("postCode") String postCode,@FormParam("portTreeType") String portTreeType);

    @POST
    @Path("/getPortTreeList1")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    ...
    @POST
    @Path("/queryPortByPortCode")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    public List<Port> queryPortByPortCode(String[] keys);

    @POST
    @Path("/PortFilter_ByTrCode_YFP")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED + ";charset=UTF-8" })
    public List<Port> PortFilter_ByTrCode_YFP(@FormParam("isDataRight") boolean isDataRight,@FormParam("datClass") String datClass,@FormParam("dvPortCode") String dvPortCode,@FormParam("trCode") String trCode) throws Exception;

    @POST
    @Path("/queryAssetTreeWithLeafNode")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    public List<AssetsTree_A> queryAssetTreeWithLeafNode() throws Exception;

    @POST
    @Path("/getTreePortByCode")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED + ";charset=UTF-8" })
    public List<Port> getTreePortByCode(@FormParam("isDataRight") boolean isDataRight,@FormParam("trCode") String trCode,@FormParam("trCodeR") String trCodeR) throws Exception;
    
    @POST
    @Path("/queryPortByTypeCondition")
    @Produces({ MediaType.APPLICATION_JSON + ";charset=UTF-8" })
    @Consumes({ MediaType.APPLICATION_FORM_URLENCODED + ";charset=UTF-8" })
    public List<Port> queryPortByTypeCondition(@FormParam("type") String type, @FormParam("codes") List<String> codes, @FormParam("isDataRight") boolean isDataRight) throws Exception;
