...
{
    public partial class Frm_ELEC_DBL_GZ_S : Frm_ELEC_BBINFO_S
    {
        /// <summary>
        /// service
        /// </summary>
        private IErDblgzbService gzService;
        ...
        {
            base.initServiceMVC();
            gzService = ServiceFactory.createService<IErDblgzbService>();
            this.dataService = gzService;
        }

        /// <summary>
        /// 估值报表
        /// </summary>
        public Frm_ELEC_DBL_GZ_S()
        {
            ////this.bbName = "对账估值表";
            InitializeComponent();
        ...
        protected override void loadBBTab()
        {
            if (tbMain.Columns.Count == 0)
            {
                ...
                QueryRes res = gzService.queryByCondition(paraDict);
