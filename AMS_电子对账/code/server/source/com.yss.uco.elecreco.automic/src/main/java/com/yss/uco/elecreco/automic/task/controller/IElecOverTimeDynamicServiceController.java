...
url = "com/yss/uco/elecreco/automic/task/controller/IElecOverTimeDynamicServiceController",
impl = "com.yss.uco.elecreco.automic.task.ElecOverTimeDynamicService",
interfaceClass = IAutomaticTaskDynamicService.class,
productLine = ProductLine.ELECRECO,
serviceMapId = "ElecOverTimeDynamicService")
public interface IElecOverTimeDynamicServiceController extends IAutomaticTaskDynamicController{
