...
import com.yss.uco.elecreco.automic.task.ElecPortDynamicService;
import com.yss.uco.elecreco.automic.task.controller.IElecPortDynamicServiceController;

public class ElecPortDynamicServiceControllerImpl extends AbstractBaseController<IAutomaticTaskDynamicService> 
implements IElecPortDynamicServiceController{
	...
	public IAutomaticTaskDynamicService getService() {
		 return RestfulLocalServiceFactory.createService(IAutomaticTaskDynamicService.class,
                 YssServiceFactory.getInstance().createServiceByImplClass(IAutomaticTaskDynamicService.class,
                		 ElecPortDynamicService.class.getName()));
	}
}
