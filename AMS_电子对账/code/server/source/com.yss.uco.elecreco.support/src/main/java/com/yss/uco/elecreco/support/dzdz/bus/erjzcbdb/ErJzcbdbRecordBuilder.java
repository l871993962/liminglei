...
public class ErJzcbdbRecordBuilder implements IRecordBuilder {
	private Logger logger = LogManager.getLogger(this.getClass());
	private IRecordSqlBuilder sqlBuilder = new ErJzcbdbSqlBuilder();
	
	@Override
	public XmlRoot setRecords(Connection conn, XmlRoot root, Map<String, String> kmMap) {
		List<ErJzcbdbElement> list = new ArrayList<ErJzcbdbElement>();
...
//			DzPara para = svc.getParaByAssCode(root.getC_ASS_CODE());
			...
			while(rs.next()) {
				ErJzcbdbElement e = (ErJzcbdbElement) rsTools.ResultToPojoObject(rs, ErJzcbdbElement.class);
				list.add(e);
