...
impl = "com.yss.uco.elecreco.er.template.service.impl.DzTemplateDataService",
interfaceClass = com.yss.uco.elecreco.er.template.service.IDzTemplateDataService.class,
productLine = ProductLine.ELECRECO, serviceMapId = "IDzTemplateDataService", menuId = "dzTemplate")
public interface IDzTemplateDataServiceController extends IBaseController<IDzTemplateDataService> {
