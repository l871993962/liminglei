package com.yss.uco.elecreco.er.erlrb.dao;
...
public class ErLrbSqlBuilder implements SQLBuilder {
	...
	public String getTableName(DBNameResolver dbNameResolver) {
		// TODO Auto-generated method stub
		return dbNameResolver.getColumnName(ErLrbTableName.lrInfo);
	}
	...
	public String getColumnNameByProperty(DBNameResolver dbNameResolver,
			String name) {
		// TODO Auto-generated method stub
		return dbNameResolver.getColumnName(ErLrbColumnName.valueOf(name));
	}
...
//		buf.append(" B.C_ZB_NAME AS C_INDEX_NAME, ");
		buf.append(" A.N_CUR_VALUE,A.N_TOL_VALUE ");
		buf.append(" FROM T_D_ER_LR A ");
...
//		buf.append(" ON P1.C_RELA_CODE = R1.C_TGH_CODE) C ON A.C_ASS_CODE = C.C_ASS_CODE ");
	...
	public String getKmSql(){
		StringBuffer buf = new StringBuffer();
		buf.append(" SELECT DISTINCT A.C_INDEX_CODE, A.C_INDEX_NAME FROM ( ");
//		buf.append(" SELECT DISTINCT A.C_INDEX_CODE, B.C_ZB_NAME AS C_INDEX_NAME FROM ( ");
		buf.append(" SELECT C_FILE_TYPE, C_INDEX_CODE FROM T_D_ER_LR WHERE C_SN =? ");
