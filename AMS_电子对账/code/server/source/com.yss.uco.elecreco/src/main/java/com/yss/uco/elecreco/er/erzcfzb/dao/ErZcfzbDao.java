...
public class ErZcfzbDao extends GeneralDao {

	public ErZcfzbDao(DbPool pool, SQLBuilder sqlBuilder) {
...
//			sql = ((ErZcfzbSqlBuilder) sqlbuilder).getKmSql();
//			
//			pstmt = conn.prepareStatement(sql);
//
//			pstmt.setObject(1, paraMap.get("C_SN"));
//			pstmt.setObject(2, paraMap.get("C_RPT_TYPE"));
//
