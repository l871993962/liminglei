CREATE OR REPLACE PROCEDURE PRC_CHK_EXISTNULL_DATA
IS
   v_sql         VARCHAR2 (4000);
...
BEGIN
   ...
   c_Exe_Type := 'CHK_EXISTS_NULL';
   c_Exe_Prc  := 'PRC_CHK_EXISTNULL_DATA';

   DELETE FROM T_CHK_EXCPTION_DATA WHERE C_EXE_TYPE = 'CHK_EXISTS_NULL';
