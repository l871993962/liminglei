...
url = "com/yss/uco/elecreco/automic/task/controller/IElecResultParamServiceController",
impl = "com.yss.uco.elecreco.automic.task.ElecResultParamService",
interfaceClass = IAutomaticTaskDynamicService.class,
productLine = ProductLine.ELECRECO,
serviceMapId = "ElecResultParamService")
public interface IElecResultParamServiceController extends IAutomaticTaskDynamicController{
