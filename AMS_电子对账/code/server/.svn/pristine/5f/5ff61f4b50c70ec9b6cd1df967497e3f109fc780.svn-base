CREATE OR REPLACE PROCEDURE PRC_CHK_TAB_COL_DATA
--待定
IS
   v_sql         VARCHAR2 (4000);
...
BEGIN
   ...
   c_Exe_Type := 'CHK_TAB_COL';
   c_Exe_Prc  := 'PRC_CHK_TAB_COL_DATA';

   DELETE FROM T_CHK_EXCPTION_DATA WHERE C_EXE_TYPE = 'CHK_TAB_COL';
