...
impl = "com.yss.uco.elecreco.er.erdztype.service.impl.ErDzTypeDataService",
interfaceClass = com.yss.uco.elecreco.support.service.IErDzTypeDataService.class,
productLine = ProductLine.ELECRECO, serviceMapId = "IErDzTypeDataService", menuId = "base_erdztype")
public interface IErDzTypeDataServiceController extends IBaseController<IErDzTypeDataService> {
