...
{
    public partial class Frm_ELEC_REVE_PUBLIC_KMMAP_L : FrmBaseList
    {
        public Frm_ELEC_REVE_PUBLIC_KMMAP_L()
        {
        ...
        protected override Dictionary<string, string> OnGetParaAssemble(Dictionary<string, string> paraDict)
        {
            try
            {
                ...
                paraDict.Add("ARRAY_C_DV_KM_CLS", search);
                //if (null != search && !"".Equals(search.Trim()))
                //{
                    
                //}

                paraDict.Add("C_DV_MAP_SCOPE", "REVE_YSFW_GGYS");
